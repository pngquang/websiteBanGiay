            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        <a href="index.php">Home<span class="fa-solid fa-chevron-right"></span></a>
                        <a href="#">Shop<span class="fa-solid fa-chevron-right"></span></a>
    ...
    <div class=" product_image_area">
        <div class="container">
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <img style="width: 100%; " class="img-fluid" src="uploads/<?=$product['avatar']?>" alt="">
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            <li><a class="active" href="#"><span>Category</span> : <?=$cate['name']?></a></li>
                        </ul>
                        <p><?=$product['content']?></p>
                        <div class="product_count">
                            <label for="qty">Quantity:</label>
                            <input type="text" name="qty" id="sst" maxlength="12" value="1" title="Quantity:" class="input-text qty">
                            <button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )) result.value++;return false;" class="increase items-count" type="button"><i class="fa-solid fa-chevron-up"></i></button>
                            <button onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 0 ) result.value--;return false;" class="reduced items-count" type="button"><i class="fa-solid fa-chevron-down"></i></button>
                        </div>
                        <div onclick="add_cart()" class="card_area d-flex align-items-center">
                            <a class="primary-btn" onclick=""> Add to Cart</a>
                        </div>
                    </div>
                </div>
            </div>
